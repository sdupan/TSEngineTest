...
#pragma warning disable 0219
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.TransformConstraintTimeline(arg0, arg1, arg2);
    ...
    // ==================== properties start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_TransformConstraintIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.TransformConstraintTimeline;
