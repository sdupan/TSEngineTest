...
#pragma warning disable 0219
    public static class DG_Tweening_DOTweenCYInstruction_WaitForPosition_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new DG.Tweening.DOTweenCYInstruction.WaitForPosition(arg0, arg1);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(DG.Tweening.DOTweenCYInstruction.WaitForPosition), result);
                    }
                }
    ...
    // ==================== properties start ====================
        ...
        internal static void G_keepWaiting(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as DG.Tweening.DOTweenCYInstruction.WaitForPosition;
