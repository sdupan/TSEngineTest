...
#pragma warning disable 0219
    public static class UnityEngine_Playables_ScriptPlayableOutput_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {

                {
                    ...
                    {
                        var result = new UnityEngine.Playables.ScriptPlayableOutput();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Playables.ScriptPlayableOutput), result);
                    }
                }
    ...
    // ==================== methods start ====================
            ...
            try
            {
        
                {
                    ...
                    ;
                    {
                        ...
                        var result = UnityEngine.Playables.ScriptPlayableOutput.Create (arg0, arg1);
        ...
        internal static void M_GetHandle(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Playables.ScriptPlayableOutput)Puerts.Utils.GetSelf((int)data, self);
    ...
    // ==================== properties start ====================
        ...
        internal static void G_Null(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var result = UnityEngine.Playables.ScriptPlayableOutput.Null;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
