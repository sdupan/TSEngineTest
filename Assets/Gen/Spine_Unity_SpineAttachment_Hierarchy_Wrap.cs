...
#pragma warning disable 0219
    public static class Spine_Unity_SpineAttachment_Hierarchy_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(Spine.Unity.SpineAttachment.Hierarchy).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== properties start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_slot(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (Spine.Unity.SpineAttachment.Hierarchy)Puerts.Utils.GetSelf((int)data, self);
