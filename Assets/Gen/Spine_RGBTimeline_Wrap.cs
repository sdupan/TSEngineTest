...
#pragma warning disable 0219
    public static class Spine_RGBTimeline_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.RGBTimeline(arg0, arg1, arg2);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.RGBTimeline), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.RGBTimeline;
        
                {
                    ...
                    ;
                    {
                        ...
                        obj.SetFrame (arg0, arg1, arg2, arg3, arg4);
    ...
    // ==================== properties start ====================
        ...
        internal static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var result = Spine.RGBTimeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
