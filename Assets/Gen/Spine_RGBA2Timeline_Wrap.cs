...
#pragma warning disable 0219
    public static class Spine_RGBA2Timeline_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.RGBA2Timeline(arg0, arg1, arg2);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.RGBA2Timeline), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.RGBA2Timeline;
    ...
    // ==================== properties start ====================
        ...
        internal static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var result = Spine.RGBA2Timeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
