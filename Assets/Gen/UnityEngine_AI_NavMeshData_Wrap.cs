...
#pragma warning disable 0219
    public static class UnityEngine_AI_NavMeshData_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 0)
                {
                    ...
                    {
                        var result = new UnityEngine.AI.NavMeshData();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.AI.NavMeshData), result);
                    }
                }
                if (paramLen == 1)
                {
...

                    {
                        ...
                        var result = new UnityEngine.AI.NavMeshData(arg0);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(UnityEngine.AI.NavMeshData).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== properties start ====================
        ...
        internal static void G_sourceBounds(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.AI.NavMeshData;
                var result = obj.sourceBounds;
