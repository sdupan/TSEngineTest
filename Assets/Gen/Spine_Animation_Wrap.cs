...
#pragma warning disable 0219
            ...
            try
            {

                {
...

                    {
                        ...
                        argobj1 = argobj1 != null ? argobj1 : StaticTranslate<Spine.ExposedList<Spine.Timeline>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false); Spine.ExposedList<Spine.Timeline> arg1 = (Spine.ExposedList<Spine.Timeline>)argobj1;
    ...
    // ==================== methods start ====================
        ...
        internal static void M_SetTimelines(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<Spine.ExposedList<Spine.Timeline>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); Spine.ExposedList<Spine.Timeline> arg0 = (Spine.ExposedList<Spine.Timeline>)argobj0;

                        obj.SetTimelines (arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_HasTimeline(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Animation;
            ...
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        ...
                        argobj4 = argobj4 != null ? argobj4 : StaticTranslate<Spine.ExposedList<Spine.Event>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value4, false); Spine.ExposedList<Spine.Event> arg4 = (Spine.ExposedList<Spine.Event>)argobj4;
                        float arg5 = (float)PuertsDLL.GetNumberFromValue(isolate, v8Value5, false);
                        Spine.MixBlend arg6 = (Spine.MixBlend)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value6, false);
                        Spine.MixDirection arg7 = (Spine.MixDirection)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value7, false);
    ...
    // ==================== properties start ====================
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_Timelines(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Animation;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_Timelines(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Animation;
