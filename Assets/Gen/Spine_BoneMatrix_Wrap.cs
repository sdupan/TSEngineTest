...
#pragma warning disable 0219
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.BoneData), false, false, v8Value0, ref argobj0, ref argType0))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(Spine.BoneMatrix).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== methods start ====================
        ...
        internal static void F_CalculateSetupWorld(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_TransformMatrix(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<Spine.BoneMatrix>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); Spine.BoneMatrix arg0 = (Spine.BoneMatrix)argobj0;
