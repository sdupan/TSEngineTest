        ...
        internal static void F_EnableKeyword(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<UnityEngine.Rendering.GlobalKeyword>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, true); UnityEngine.Rendering.GlobalKeyword arg0 = (UnityEngine.Rendering.GlobalKeyword)argobj0;
        ...
        internal static void M_FindPassTagValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    {
                        int arg0 = (int)PuertsDLL.GetNumberFromValue(isolate, v8Value0, false);
                        argobj1 = argobj1 != null ? argobj1 : StaticTranslate<UnityEngine.Rendering.ShaderTagId>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false); UnityEngine.Rendering.ShaderTagId arg1 = (UnityEngine.Rendering.ShaderTagId)argobj1;
                ...
                if (paramLen == 3)
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.Number, typeof(int), false, false, v8Value0, ref argobj0, ref argType0) && ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.Number, typeof(int), false, false, v8Value1, ref argobj1, ref argType1) && ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.Rendering.ShaderTagId), false, false, v8Value2, ref argobj2, ref argType2))
                    {
                        ...
                        argobj2 = argobj2 != null ? argobj2 : StaticTranslate<UnityEngine.Rendering.ShaderTagId>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value2, false); UnityEngine.Rendering.ShaderTagId arg2 = (UnityEngine.Rendering.ShaderTagId)argobj2;
