...
#pragma warning disable 0219
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.TranslateTimeline(arg0, arg1, arg2);
    ...
    // ==================== methods start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_GetCurveValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.TranslateTimeline;
        
                {
                    ...
                    ;
                    {
                        ...
                        obj.GetCurveValue (out arg0, out arg1, arg2);
