...
#pragma warning disable 0219
    ...
    // ==================== methods start ====================
        ...
        internal static void F_AddSubTextObject(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    ;
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<TMPro.TextMeshProUGUI>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); TMPro.TextMeshProUGUI arg0 = (TMPro.TextMeshProUGUI)argobj0;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_SetPivotDirty(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_SubMeshUI;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_RefreshMaterial(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_SubMeshUI;
