...
#pragma warning disable 0219
        ...
        internal static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(Spine.Unity.SkeletonGraphicCustomMaterials.AtlasMaterialOverride), false, false, v8Value0, ref argobj0, ref argType0))
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<Spine.Unity.SkeletonGraphicCustomMaterials.AtlasMaterialOverride>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); Spine.Unity.SkeletonGraphicCustomMaterials.AtlasMaterialOverride arg0 = (Spine.Unity.SkeletonGraphicCustomMaterials.AtlasMaterialOverride)argobj0;
    ...
    // ==================== properties start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_replacementMaterial(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (Spine.Unity.SkeletonGraphicCustomMaterials.AtlasMaterialOverride)Puerts.Utils.GetSelf((int)data, self);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_replacementMaterial(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (Spine.Unity.SkeletonGraphicCustomMaterials.AtlasMaterialOverride)Puerts.Utils.GetSelf((int)data, self);
