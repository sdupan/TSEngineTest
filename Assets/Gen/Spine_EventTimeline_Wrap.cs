        ...
        internal static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    {
                        int arg0 = (int)PuertsDLL.GetNumberFromValue(isolate, v8Value0, false);
                        argobj1 = argobj1 != null ? argobj1 : StaticTranslate<Spine.Event>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false); Spine.Event arg1 = (Spine.Event)argobj1;
