...
#pragma warning disable 0219
    public static class Spine_RGB2Timeline_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.RGB2Timeline(arg0, arg1, arg2);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.RGB2Timeline), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.RGB2Timeline;
        
                {
                    ...
                    ;
                    {
                        ...
                        obj.SetFrame (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    ...
    // ==================== properties start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var result = Spine.RGB2Timeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
