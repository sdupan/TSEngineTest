        ...
        internal static void M_GetShapeData(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<System.Collections.Generic.List<UnityEngine.PhysicsShape2D>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); System.Collections.Generic.List<UnityEngine.PhysicsShape2D> arg0 = (System.Collections.Generic.List<UnityEngine.PhysicsShape2D>)argobj0;
