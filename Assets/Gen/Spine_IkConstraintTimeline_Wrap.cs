...
#pragma warning disable 0219
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.IkConstraintTimeline(arg0, arg1, arg2);
    ...
    // ==================== properties start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_IkConstraintIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.IkConstraintTimeline;
