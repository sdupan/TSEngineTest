        ...
        internal static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<UnityEngine.GraphicsBufferHandle>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); UnityEngine.GraphicsBufferHandle arg0 = (UnityEngine.GraphicsBufferHandle)argobj0;
            ...
            {
                {
                    ...
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<UnityEngine.GraphicsBufferHandle>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); UnityEngine.GraphicsBufferHandle arg0 = (UnityEngine.GraphicsBufferHandle)argobj0;
                        argobj1 = argobj1 != null ? argobj1 : StaticTranslate<UnityEngine.GraphicsBufferHandle>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false); UnityEngine.GraphicsBufferHandle arg1 = (UnityEngine.GraphicsBufferHandle)argobj1;
