    ...
    // ==================== events start ====================
        ...
        internal static void A_memoryUsageChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                argobj0 = argobj0 != null ? argobj0 : StaticTranslate<UnityEngine.Application.MemoryUsageChangedCallback>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); UnityEngine.Application.MemoryUsageChangedCallback arg0 = (UnityEngine.Application.MemoryUsageChangedCallback)argobj0;
