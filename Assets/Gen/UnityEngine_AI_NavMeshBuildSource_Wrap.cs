...
#pragma warning disable 0219
    public static class UnityEngine_AI_NavMeshBuildSource_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {

                {
                    ...
                    {
                        var result = new UnityEngine.AI.NavMeshBuildSource();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.AI.NavMeshBuildSource), result);
                    }
                }
    ...
    // ==================== properties start ====================
        ...
        internal static void G_transform(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.AI.NavMeshBuildSource)Puerts.Utils.GetSelf((int)data, self);
        ...
        internal static void S_shape(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                UnityEngine.AI.NavMeshBuildSourceShape arg0 = (UnityEngine.AI.NavMeshBuildSourceShape)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
                obj.shape = arg0;
                Puerts.Utils.SetSelf((int)data, self, obj);
            }
            catch (Exception e)
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_sourceObject(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.AI.NavMeshBuildSource)Puerts.Utils.GetSelf((int)data, self);
                var result = obj.sourceObject;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_sourceObject(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.AI.NavMeshBuildSource)Puerts.Utils.GetSelf((int)data, self);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_component(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.AI.NavMeshBuildSource)Puerts.Utils.GetSelf((int)data, self);
