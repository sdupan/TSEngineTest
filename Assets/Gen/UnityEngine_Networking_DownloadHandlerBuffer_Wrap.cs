...
#pragma warning disable 0219
    public static class UnityEngine_Networking_DownloadHandlerBuffer_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {

                {
                    ...
                    {
                        var result = new UnityEngine.Networking.DownloadHandlerBuffer();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Networking.DownloadHandlerBuffer), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_Dispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Networking.DownloadHandlerBuffer;
            ...
            try
            {
        
                {
                    ...
                    ;
                    {
                        ...
                        var result = UnityEngine.Networking.DownloadHandlerBuffer.GetContent (arg0);
