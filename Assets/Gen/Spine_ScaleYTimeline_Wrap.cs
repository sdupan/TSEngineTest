...
#pragma warning disable 0219
    public static class Spine_ScaleYTimeline_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.ScaleYTimeline(arg0, arg1, arg2);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.ScaleYTimeline), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_Apply(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.ScaleYTimeline;
