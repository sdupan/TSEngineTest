...
#pragma warning disable 0219
    public static class Spine_ScaleXTimeline_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.ScaleXTimeline(arg0, arg1, arg2);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.ScaleXTimeline), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_Apply(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.ScaleXTimeline;
