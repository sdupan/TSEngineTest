...
#pragma warning disable 0219
    public static class Spine_Unity_SpineBone_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(Spine.Unity.SpineBone).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== methods start ====================
        ...
        internal static void F_GetBone(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    {
                        string arg0 = (string)PuertsDLL.GetStringFromValue(isolate, v8Value0, false);
                        argobj1 = argobj1 != null ? argobj1 : StaticTranslate<Spine.Unity.SkeletonRenderer>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false); Spine.Unity.SkeletonRenderer arg1 = (Spine.Unity.SkeletonRenderer)argobj1;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_GetBoneData(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    {
                        string arg0 = (string)PuertsDLL.GetStringFromValue(isolate, v8Value0, false);
                        argobj1 = argobj1 != null ? argobj1 : StaticTranslate<Spine.Unity.SkeletonDataAsset>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false); Spine.Unity.SkeletonDataAsset arg1 = (Spine.Unity.SkeletonDataAsset)argobj1;
