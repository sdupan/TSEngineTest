...
#pragma warning disable 0219
    public static class DG_Tweening_Color2_Wrap 
    {
            ...
            try
            {
                ...
                if (paramLen == 2)
                {
...

                    {
                        ...
                        var result = new DG.Tweening.Color2(arg0, arg1);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(DG.Tweening.Color2), result);
                    }
                }
                if (paramLen == 0)
                {
                    ...
                    {
                        var result = new DG.Tweening.Color2();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(DG.Tweening.Color2).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== properties start ====================
        ...
        internal static void G_ca(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (DG.Tweening.Color2)Puerts.Utils.GetSelf((int)data, self);
                var result = obj.ca;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_ca(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (DG.Tweening.Color2)Puerts.Utils.GetSelf((int)data, self);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_cb(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (DG.Tweening.Color2)Puerts.Utils.GetSelf((int)data, self);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_cb(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (DG.Tweening.Color2)Puerts.Utils.GetSelf((int)data, self);
