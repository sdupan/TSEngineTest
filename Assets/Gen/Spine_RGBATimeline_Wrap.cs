...
#pragma warning disable 0219
    public static class Spine_RGBATimeline_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new Spine.RGBATimeline(arg0, arg1, arg2);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.RGBATimeline), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.RGBATimeline;
    ...
    // ==================== properties start ====================
        ...
        internal static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var result = Spine.RGBATimeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
