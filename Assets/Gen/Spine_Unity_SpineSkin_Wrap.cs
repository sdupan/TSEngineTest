...
#pragma warning disable 0219
    public static class Spine_Unity_SpineSkin_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(Spine.Unity.SpineSkin).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== properties start ====================
        ...
        internal static void G_defaultAsEmptyString(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_defaultAsEmptyString(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.SpineSkin;
