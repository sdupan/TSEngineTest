    ...
    public class TextDataProvider : ResourceProviderBase
    {
        ...
        internal class InternalOp
        {
            ...
            private void RequestOperation_completed(AsyncOperation op)
            {
                ...
                if(textResult == null)
                {
                    UnityEngine.Debug.Log("[GameEntry] - TextDataProvider - RequestOperation_completed textResult is null, retry again later...");
            ...
            private async System.Threading.Tasks.Task RetryRequest()
            {
                await System.Threading.Tasks.Task.Delay(500);
                var path = m_PI.ResourceManager.TransformInternalId(m_PI.Location);
                UnityEngine.Debug.Log("[GameEntry] - TextDataProvider - RetryRequest -> SendWebRequest " + path);
                SendWebRequest(path);
            }
